...
<div id="formmail" class="new_win">
    ...
    <form name="fformmail" action="../../../../../gnuboard5.3.1.6/mobile/skin/member/basic/formmail_send.php" onsubmit="return fformmail_submit(this);" method="post" enctype="multipart/form-data" style="margin:0px;">
