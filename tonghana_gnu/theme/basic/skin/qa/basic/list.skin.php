...
<div id="bo_list">
    ...
    <form name="fqalist" id="fqalist" action="../../../../../../gnuboard5.3.1.6/theme/basic/skin/qa/basic/qadelete.php" onsubmit="return fqalist_submit(this);" method="post">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_subject">
                ...
                <a href="<?php echo $list[$i]['../../../../../../gnuboard5.3.1.6/theme/basic/skin/qa/basic/view_href']; ?>" class="bo_tit">
