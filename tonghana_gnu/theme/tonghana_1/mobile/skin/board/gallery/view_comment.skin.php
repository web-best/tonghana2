        ...
        <div class="cmt_contents">
            ...
            ?>
                <ul class="bo_vc_act">
                    ...
                    <?php if ($list[$i]['is_del'])  { ?><li><a href="<?php echo $list[$i]['../../../../../../../gnuboard5.3.1.6/theme/tonghana_1/mobile/skin/board/gallery/del_link']; ?>" onclick="return comment_delete();">삭제</a></li><?php } ?>
                </ul>
            <?php } ?>
        </div>
