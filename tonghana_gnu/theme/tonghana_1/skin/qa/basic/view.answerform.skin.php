...
<section id="bo_v_ans_form">
    ...
    <form name="fanswer" method="post" action="../../../../../../gnuboard5.3.1.6/theme/tonghana_1/skin/qa/basic/qawrite_update.php" onsubmit="return fwrite_submit(this);" autocomplete="off">
