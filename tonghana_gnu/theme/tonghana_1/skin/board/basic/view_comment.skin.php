    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        ...
        <div class="cmt_contents">
            ...
            <ul class="bo_vc_act">
                ...
                <?php if ($list[$i]['is_del'])  { ?><li><a href="<?php echo $list[$i]['../../../../../../gnuboard5.3.1.6/theme/tonghana_1/skin/board/basic/del_link'];  ?>" onclick="return comment_delete();" class="btn_b03">삭제</a></li><?php } ?>
            </ul>
            <?php } ?>
        </div>
