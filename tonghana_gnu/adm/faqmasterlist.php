...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mng td_mng_l">
            ...
            <a href="<?php echo G5_BBS_URL; ?>/faq.php?fm_id=<?php echo $row['../../gnuboard5.3.1.6/adm/fm_id']; ?>" class="btn btn_02"><span class="sound_only"><?php echo stripslashes($row['fm_subject']); ?> </span>보기</a>
