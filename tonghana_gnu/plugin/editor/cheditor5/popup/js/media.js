...
function play()
{
    ...
    var mediaobj = "<embed src='../../../../../../gnuboard5.3.1.6/plugin/editor/cheditor5/popup/js/"+file.value+"' autostart='true' loop='true'></embed>";
...
{
    var file = document.getElementById("fm_linkurl");
    var media = "<embed src='../../../../../../gnuboard5.3.1.6/plugin/editor/cheditor5/popup/js/"+file.value+"' autostart='true' loop='true'></embed>";
