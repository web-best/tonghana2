...
nhn.husky.SE2M_Hyperlink = jindo.$Class({
	...
	_generateAutoLink : function(sAll, sBreaker, sURL, sWWWURL, sHTTPURL) {
		...
		if (sWWWURL){
			...
			sResult = '<a href="../../../../../gnuboard5.3.1.6/plugin/editor/smarteditor2/js/'+sHTTPURL+'">'+sURL+'</a>';
		}
			...
			if(this.oSelection.collapsed){
				...
				if(sURL == ""){	// unlink
					...
					if(this._isExceptional()){
						...
						var sTempUrl = "<a href='../../../../../gnuboard5.3.1.6/plugin/editor/smarteditor2/js/" + sURL + "' target="+sTarget+">";
