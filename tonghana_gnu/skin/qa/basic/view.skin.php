            ...
            for ($i=0; $i<$view['download_count']; $i++) {
             ?>
                <li>
                    ...
                    <a href="<?php echo $view['../../../../gnuboard5.3.1.6/skin/qa/basic/download_href'][$i];  ?>" class="view_file_download">
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            <tr>
                <td>
                    ...
                    <a href="<?php echo $rel_list[$i]['../../../../gnuboard5.3.1.6/skin/qa/basic/view_href']; ?>" class="bo_tit">
